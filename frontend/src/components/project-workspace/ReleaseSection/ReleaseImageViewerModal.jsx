          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <Space direction="vertical" size="small" style={{ width: '100%' }}>
              <Button
                ...
                style={{ 
                  width: '100%',
                  background: drawingMode ? '#e74c3c' : undefined,
                  borderColor: drawingMode ? '#e74c3c' : undefined,
                }}
                size="small"
              >
                ✏️ {drawingMode ? 'Drawing Mode ON' : 'Pen Tool'}
              </Button>
              ...
              <Button
                ...
                style={{ 
                  ...
                  borderColor: textMode ? '#e74c3c' : undefined,
                }}
                size="small"
              >
                T {textMode ? 'Text Mode ON' : 'Text Tool'}
              </Button>
              ...
              {hasDrawings && (
                <>
                  ...
                  <Button
                    ...
                    onClick={downloadImageWithDrawings}
                    type="primary"
                    style={{ 
                      width: '100%',
                      background: '#27ae60', 
